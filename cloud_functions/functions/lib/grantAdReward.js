...
exports.grantAdReward = void 0;
const admin = __importStar(require("firebase-admin"));
const https_1 = require("firebase-functions/v2/https");
const ledger_1 = require("./lib/ledger");
const DAILY_CAP = 50;
const REWARD_AMOUNT = 12;
exports.grantAdReward = (0, https_1.onCall)(async (request) => {
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'Sign in required');
    }
    const userId = request.auth.uid;
    const { adUnitId, adId } = request.data;
    if (typeof adUnitId !== 'string' || typeof adId !== 'string') {
        throw new https_1.HttpsError('invalid-argument', 'Missing adUnitId or adId');
    }
    ...
    if (todayTx.size >= DAILY_CAP) {
        throw new https_1.HttpsError('resource-exhausted', 'Daily ad cap reached');
    }
